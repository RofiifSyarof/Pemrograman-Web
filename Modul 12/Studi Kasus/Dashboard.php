...
<body style="background-color:rgba(52,53,65);">
    <section style="color: #fff">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="hapus.php?nama=<?php echo $data['nama']; ?>" onclick="return hapus()">hapus</a>
                        </td>
                    </tr>
                <?php 
                } ?>
        ...
        <div>
            ...
            <form action="" method="post">
                ...
                if (isset($_POST['simpan'])) {
                    ...
                    $alamat = $_POST['alamat'];
                    $query = mysqli_query($koneksi, "INSERT INTO pasien (nama, keluhan, alamat) VALUES ('$nama','$keluhan','$alamat')") or die(mysqli_error());
                    if ($query) {
                    ?>
                        <script>
        ...
        <br>
        <a href="Logout.php" onclick="return logout()"><h3>Log Out</h3></a>
    </section>
</body>
</html>